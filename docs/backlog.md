...
| **ID**  | **Título**     | **Descrição**      | **Critérios de Aceitação**      |
|---------|----------------------|-------------|--------------|
| **US01**| Cadastro de Empresa | Eu, como gestor de uma empresa, gostaria de cadastrar novas empresas (nome, CNPJ, email, etc.), a fim de manter um registro completo. | <a>1</a> - Campos obrigatórios: nome, CNPJ, email.|
...
| **US11**| Cadastro de Funcionários | Eu, como gestor da empresa, gostaria de cadastrar novos funcionários, associando-os a uma filial específica, a fim de organizar o quadro de colaboradores.| <a>1</a> - Campos obrigatórios: nome completo, CPF e e-mail. <br><a>2</a> - O sistema deve permitir selecionar uma filial já cadastrada para vincular o funcionário. <br><a>3</a> - O sistema não deve permitir o cadastro de um funcionário com um CPF já existente.|
| **US12**| Listagem do Número Total de Funcionários | Eu, como gestor da empresa, gostaria de visualizar o número total de funcionários cadastrados na empresa, somando os colaboradores de todas as filiais, a fim de ter uma visão consolidada do quadro de pessoal.|<a>1</a> - O sistema deve exibir o número total de funcionários da empresa em um local de fácil acesso (ex: dashboard principal). <br><a>2</a> - A contagem deve ser o resultado da soma de todos os funcionários ativos em todas as filiais.|
...
| `1.2` | 18/06/2025 | Criação da US11 e da US12|