...
class IsGestor(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        return (
            ...
            and request.user.tipo_usuario == 'GESTOR'
        )
...
class IsManagerOfParentCompany(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (
            ...
            and user.empresa_administrada
            .filter(pk=empresa_pk)
            .exists()
        )
...
class IsOwnerOrManagerOfSameCompany(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        is_target_funcionario = (
            obj.tipo_usuario == 'FUNCIONARIO'
            and obj.filial_associada is not None
        )
        ...
        if is_gestor and is_target_funcionario:
            ...
            return (
                request.user.empresa_administrada
                .filter(pk=empresa_do_funcionario.pk)
                .exists()
            )
