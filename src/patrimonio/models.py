...
class ItemDePatrimonio(models.Model):
    ...
    filial_associada = models.ForeignKey('empresa_filial.Filial', on_delete=models.CASCADE, related_name='%(class)s_associado')
...
class Imobiliario(ItemDePatrimonio):
    ...
    endereco = models.OneToOneField('empresa_filial.Endereco', on_delete=models.CASCADE, verbose_name="Endereço")
